...
Save undo data." t nil)

(autoload 'undo-fu-session-recover "undo-fu-session" "\
Recover undo data." t nil)

(autoload 'undo-fu-session-compression-update "undo-fu-session" "\
Update existing undo session data after changing compression settings." t nil)
...
;;;***

;;;### (autoloads nil nil ("undo-fu-session-pkg.el") (0 0 0 0))
