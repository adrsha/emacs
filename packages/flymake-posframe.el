...
(defface flymake-posframe-error-face
  '((t :inherit flymake-error))
  "The background color of the flymake-posframe frame.
Only the `background' is used in this face."
  :group 'flymake-posframe)

(defface flymake-posframe-warning-face
  '((t :inherit flymake-warning))
  "The background color of the flymake-posframe frame.
Only the `background' is used in this face."
  :group 'flymake-posframe)

(defface flymake-posframe-note-face
			        ...
			        (pcase (flymake--diag-type diag)
                      (:error
                       (propertize
                        ...
                        'face 'flymake-posframe-error-face)
                       )
                      (:warning
                       (propertize
                        (concat
                        ...
                        'face 'flymake-posframe-warning-face)
                       )
                      (:note
                       (propertize
                        (concat
                        ...
                        'face 'flymake-posframe-note-face)
                       )
                      )
                    "\n  "
                    (propertize
			         (flymake--diag-text diag)
                     'face 'flymake-posframe-foreground-face)
                     ))
