...
;;; INFO: MODIFIED!!
;; (if (and (buffer-file-name) (buffer-modified-p))
;;                                                (propertize " 󰈈 " 'face 'eaBattery-charge-icon)
;;                                              "  "
;;                                              )
...
;;   (bc--summarize
;;    (list
;;     (propertize (projectile-project-name) 'face 'bc-project-leaf-face)
;;     (propertize (directory-file-name
;;                  (file-relative-name
;;                   (file-name-directory
;;                    (directory-file-name
...
;;                     ))
;;                   (file-truename
;;                    ( if (equal projectile-project-root nil) (progn "") (progn projectile-project-root))
;;                    )
;;                   )
;;                  )
;;                 'face 'bc-project-crumbs-face)
;;     (propertize (buffer-name) 'face 'bc-project-leaf-face)
;;    ;; )
;;    (bc--length bc-project-max-length)
;;    (propertize bc-project-crumb-separator
;;                'face 'bc-project-crumbs-face)))
